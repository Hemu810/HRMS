...
EMPLOYEES = [
    ...
    ("EMP-0001","Rajanikanth","Reddy","Tippasani","Rajanikanth Reddy Tippasani",
     ...
     100,"Full-time","20 months",4,False,DIR_PASS),
    ...
    ("EMP-0002","Radhika","","T","T. Radhika",
     ...
     30,"Full-time","12 months",3,True,MGR_PASS),
    ...
    ("EMP-0003","Vijay","","Ramteke","Vijay Ramteke",
     ...
     25,"Full-time","12 months",3,False,MGR_PASS),
    ...
    ("EMP-0004","Tech","","Lead","Tech Lead",
     ...
     25,"Full-time","12 months",2,False,LEAD_PASS),
    ...
    ("EMP-0005","Hemanth","Reddy","Kethu","Hemanth Reddy Kethu",
     ...
     18,"Full-time","12 months",1,False,EMP_PASS),

    ("EMP-0006","Sakethram","","Katakam","Sakethram Katakam",
     "Technology","Software Engineer","sakethram.katakam@doloxe.com","+91 7337257805","Hyderabad",
     ...
     12,"Full-time","12 months",1,False,EMP_PASS),
    ...
    ("EMP-0007","Punit","","Pal","Punit Pal",
     ...
     35,"Full-time","12 months",3,False,MGR_PASS),
    ...
    ("EMP-0008","Data","","Lead","Data Lead",
     ...
     22,"Full-time","2 months",2,False,LEAD_PASS),
    ...
    ("EMP-0009","Senior","","Analyst","Senior Analyst",
     ...
     14,"Full-time","1 month",1,False,EMP_PASS),
    ...
    ("EMP-0010","Esther","","Rani","Esther Rani",
     ...
     8,"Full-time","1 month",1,False,EMP_PASS),
    ...
    ("EMP-0011","Pravalika","","Gudelli","Pravalika Gudelli",
     ...
     8,"Full-time","12 month",1,False,EMP_PASS),
    ...
    ("EMP-0015","Sales","","Manager","Sales Manager",
     ...
     30,"Full-time","3 months",3,False,MGR_PASS),
    ...
    ("EMP-0016","APAC","","Executive","APAC Executive",
     ...
     10,"Full-time","1 month",1,False,EMP_PASS),
