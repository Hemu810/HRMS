...
EMPLOYEES = [
    ...
    ("EMP-0001","Rajanikanth","Reddy","Tippasani","Rajanikanth Reddy Tippasani",
     "Leadership","Director","rajanikanth.tippasani@doloxe.com","+91 9966249234","Hyderabad",
     ...
     100,"Full-time","6 months",4,False,5.0,DIR_PASS),
    ...
    ("EMP-0002","Radhika","","T","T. Radhika",
     ...
     30,"Full-time","3 months",3,True,4.7,MGR_PASS),
    ...
    ("EMP-0003","Vijay","","Ramteke","Vijay Ramteke",
     ...
     25,"Full-time","3 months",3,False,4.8,MGR_PASS),
    ...
    ("EMP-0004","Tech","","Lead","Tech Lead",
     ...
     25,"Full-time","2 months",2,False,4.5,LEAD_PASS),
    ...
    ("EMP-0005","Hemanth","Reddy","Kethu","Hemanth Reddy Kethu",
     ...
     18,"Full-time","2 months",1,False,4.4,EMP_PASS),
    ...
    ("EMP-0006","Sakethram","Katakam","","Sakethram Katakam",
     ...
     "Kotak Mahindra Bank","XXXX XXXX ","HDFC",
     12,"Full-time","12 month",1,False,4.2,EMP_PASS),
    ...
    ("EMP-0007","Punit","","Pal","Punit Pal",
     ...
     35,"Full-time","3 months",3,False,4.6,MGR_PASS),
